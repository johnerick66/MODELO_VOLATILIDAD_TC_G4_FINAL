...
# DEPURAR selected_vars (aunque ya está bien)
...
# ============================================================
    ...
    st.header("Rendimientos Logarítmicos")
...
# ============================================================
    ...
    if ejecutar:
        ...
        # Construir lista de meses futuros
        meses_futuro = []
        ...
        # Construir EXACTAMENTE X con selected_vars
        X_futuro = pd.DataFrame(columns=selected_vars)

        for anio_val, mes_val in meses_futuro:
            f = ultimo_row.copy()
            f["anio"] = anio_val  # actualizar año futuro
            X_futuro.loc[len(X_futuro)] = f
        ...
        ax.plot(df["TC"], label="TC Histórico")
